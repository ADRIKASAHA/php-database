...
function test_input($data) {
 ...
 ?>
  ...
  <fieldset>
    <h1 style="color: gray;"><u>Basic Information</u></h1>
	<form action="connect.php" method="POST" autocomplete="off" novalidate>
		...
		<h1 align="center" style="color:gray;"><u>Contact Information</u></h1>
  ...
  <span class="error">*<?php echo $emailErr;?></span>" 
		...
		<label for="Lienk">Personal WebLienk : </label>
		 <input type="url" id="Lienk" name="Lienk" >
		 <br><br>


		<h1 style="color:gray;"><u>Account Information:</u></h1>
		<br>
